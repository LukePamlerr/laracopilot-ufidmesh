...
<div class="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center px-4">
    <div class="text-center max-w-2xl mx-auto">
        <!-- 500 Icon -->
        <div class="mb-8">
            <div class="w-32 h-32 bg-gradient-to-r from-red-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 animate-float">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/50">
            ...
            <a href="mailto:support@businesspro.com" class="text-red-600 hover:text-red-700 font-medium">support@businesspro.com</a>
        </div>
    </div>
</div>
@endsection